...
namespace StackOverflowProject.ServiceLayer
{
    ...
    public class QuestionsService : IQuestionsService
    {
        ...
        public void InsertQuestion(NewQuestionViewModel qvm)
        {
            ...
            Question q = mappper.Map<NewQuestionViewModel, Question>(qvm);
            qr.InsertQuestion(q);
        }

        public void UpdateQuestionDetails(EditQuestionViewModel qvm)
        {
            var config = new MapperConfiguration(cfg => { cfg.CreateMap<EditAnswerViewModel, Question>(); cfg.IgnoreUnmapped(); });
            IMapper mappper = config.CreateMapper();
            Question q = mappper.Map<EditQuestionViewModel, Question>(qvm);
